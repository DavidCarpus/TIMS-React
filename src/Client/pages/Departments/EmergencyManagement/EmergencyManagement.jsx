...
export default function EmergencyManagement({group, store, loading, id, title='Emergency Management'}){
    return (
        <Row id='EmergencyManagement'>
            {pageNav()}
            ...
            <Col  md={{size:10, push:1}}>
                ...
                <DocumentList group={group} store={store} title='EmergencyManagement' />
