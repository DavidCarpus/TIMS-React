    ...
    return (
        <div>
            ...
            <div id="contentArea"  className={layoutStyles.contentArea}>
                ...
                <p>The Assessing Department is charged by State law with discovering, describing, and valuing real property for taxation purposes. The Department's job is diverse and involves the following responsibilities:
                    </p>
                <ul>
